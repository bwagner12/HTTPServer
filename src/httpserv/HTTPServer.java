...
public class HTTPServer {
    ...
    static class MyHandler implements HttpHandler {
        ...
        public void handle(HttpExchange t) throws IOException {
        	...
        	if (req.equalsIgnoreCase("GET")) {
        		...
        		// These next lines format the input into s number so we can add the two together
    ...
    /**
     * Will load the web page index.html and inject a string (addon) at the bottom of the page
     * @param t
     * @param addon
     * @throws IOException
     */
    ...
    /**
     * Shuts down the server. There are problems with this though, as it seems fragments are still running in the background.
     * @author bwagner
     *
     */
